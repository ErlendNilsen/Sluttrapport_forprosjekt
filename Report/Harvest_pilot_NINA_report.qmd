...
The extent of the study areas were predominately regional or local, with very few studies at the site level (@fig-Study_area).
...
Studies are typically observational (106 studies; @fig-Research_type) and with simple (and less robust) study designs (@fig-Study_design). There were only 6 papers using a Randomised Controlled Trial (RCT), the study design that leads to the highest level of evidence for causal understanding (@christie2019simple) and these were limited to Norway (5) and the USA (1). The Norwegian articles are all from the same study (@sandercock2011hunting, @br2010disturbance, @pedersen2004weak, @broseth2000hunting, @broseth2005dispersal). <!--# Is this correct? -->
