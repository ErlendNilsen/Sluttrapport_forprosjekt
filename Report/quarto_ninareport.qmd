...
Harvesting of wildlife has long tradition in human history (refs). <!--# Short on development - short on grouse harvest in Scandinavia - end with adaptive management -->

To understand how harvesting affects wildlife populations, it is essential to understand to which extent harvest is additive or compensatory (refs). <!--# Write here about additivity etc -->

The choice of study design has a great effect on our ability to draw inference (ref). In general, designs that include
...
This report is a part of the planning stage of such a replication experiment. It includes two main sections:
