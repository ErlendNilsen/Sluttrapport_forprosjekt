...
The planned harvest experiment will rely on the existing line transect surveys gathered through Hønsefuglportalen (Ref). In cooperation with Statskog and selected "Fjellstyrer" in Norway the planned experiment will have access to a range of hunting areas from mid-Norway and northern Norway, covering a latitudinal gradient between approx. 58 <!-- (if Njardarheim is included) --> and 69 degrees. <!--# More here -->.
