...
The [protocol](https://osf.io/ny2jt/) i.e., the workflow of identifying, categorising and analysing the exisiting literature, was prepared prior to conducting the search. Here, we include the relevant information and report any deviation from the protocol.

## Objective of the review and research question

The main objective of this review is to map the available literature on effects of managed harvest/hunting on species of the order Galliformes. <!-- Do we need this section ? Isnt it already answered under the previous part ? (Systematic mapping of the literature) -->
