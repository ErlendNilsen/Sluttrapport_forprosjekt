...
This systematic map is produced as part of the preparation of a large-scale harvest experiment in Norway outlined above. <!--# Matt - can you write something here? Does not have to be long, but should make sense in light of the introduction --> The protocol was prepared prior to conducting the search. Here, we include the relevant information and report any deviation from the protocol.
